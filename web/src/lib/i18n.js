...
const dict = {
  zh: {
    ...
    'settings.translationDesc': '微软翻译服务（敬请期待）',
    'settings.translationToggle': '启用翻译',
    'settings.translationToggleDesc': '在文章等内容区域显示翻译按钮',
    'settings.translationDisplay': '显示模式',
    'settings.translationDisplayTrans': '纯译文',
    'settings.translationDisplayBilingual': '双语对照',
    'settings.translationTest': '测试翻译服务',
    'settings.translationTestDesc': '翻译预设示例文本验证服务可用性',
    'settings.translationComingSoon': '翻译功能正在开发中，敬请期待！',
    'settings.statusBar': '状态栏',
    'settings.statusBarDesc': '调整状态栏适配与高度',
    'settings.statusBarToggle': '状态栏适配',
    'settings.statusBarToggleDesc': '页面顶部留出状态栏安全区域',
    'settings.statusBarHeight': '状态栏高度',
    'settings.statusBarHeightDesc': '自定义状态栏占用高度',
    'common.retry': '重试',
  },
  en: {
    'common.save': 'Save',
