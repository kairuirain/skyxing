...
import { MessageSquare, Send, Trash2, PenSquare, RefreshCw, Wifi, WifiOff, Loader } from 'lucide-react';
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-bold flex items-center gap-2"><MessageSquare size={22}/> 私信</h1>
